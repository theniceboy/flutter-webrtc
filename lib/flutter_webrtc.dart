...
export 'src/native/factory_impl.dart' if (dart.library.js_interop) 'src/web/factory_impl.dart';
...
export 'src/native/utils.dart' if (dart.library.js_interop) 'src/web/utils.dart';
